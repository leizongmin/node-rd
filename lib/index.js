 ...
 * @param {Function} callback
 */
exports.eachFilePattern = function () {
  var args = stripPattern(getEachArguments(arguments));
  var findOne = getFindOne(arguments);
  var callback = getCallback(arguments);
  var test = patternToFunction(getPattern(arguments));
 ...
 * @param {Function} callback
 */
exports.eachDirPattern = function () {
  var args = stripPattern(getEachArguments(arguments));
  var findOne = getFindOne(arguments);
  var callback = getCallback(arguments);
  var test = patternToFunction(getPattern(arguments));
 ...
 * @param {Function} callback
 */
exports.readFilePattern = function () {
  var args = stripPattern(getReadArguments(arguments));
  var callback = getCallback(arguments);
  var test = patternToFunction(getPattern(arguments));
  var list = [];
 ...
 * @param {Function} callback
 */
exports.readDirPattern = function () {
  var args = stripPattern(getReadArguments(arguments));
  var callback = getCallback(arguments);
  var test = patternToFunction(getPattern(arguments));
  var list = [];
 ...
 * @param {Function} findOne
 */
exports.eachPatternSync = function (dir, pattern, findOne) {
 ...
 * @param {Function} findOne
 */
exports.eachFilePatternSync = function (dir, pattern, findOne) {
  var test = patternToFunction(pattern);
 ...
 * @return {Array}
 */
exports.readPatternSync = function (dir, pattern) {
  var list = [];
  exports.eachPatternSync(dir, pattern, function (f, s) {
    list.push(f);
  });
  return list;
};
 ...
 * @return {Array}
 */
exports.readFilePatternSync = function (dir, pattern) {
  var list = [];
  exports.eachFilePatternSync(dir, pattern, function (f, s) {
    list.push(f);
  });
  return list;
};
 ...
 * @param {Function} findOne
 */
exports.eachDirPatternSync = function (dir, pattern, findOne) {
  var test = patternToFunction(pattern);
 ...
 * @return {Array}
 */
exports.readDirPatternSync = function (dir, pattern) {
  var list = [];
  exports.eachDirPatternSync(dir, pattern, function (f, s) {
    list.push(f);
  });
  return list;
};
